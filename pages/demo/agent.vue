...
async function handleSend(){
  ...
  const res = await $fetch('/api/demo/agent/rag/conversation-chat', {
    method: 'POST',
    body: {
  ...
  chatHistory.value.push(['user', chatValue.value])
  chatHistory.value.push(['assistant', res.output])
}
...
<template>
  <div class="flex flex-col w-full">
    ...
    <div>
      ...
      <UButton @click="doClearConversation" color="red">清除聊天记录</UButton>
    </div>
    <!-- 聊天框 -->
    <div>
      <div v-for="chatMessage in chatHistory">
